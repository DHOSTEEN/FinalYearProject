 ...
 */
   ...
   public class AlphaBetaNodeTEST{
    ...
    public void setCurrentBoard(char[][] currentBoard) {
       ...
       // public ArrayList<Node> childNodes;// need to be checkd. other option have max number of possible child nodes and only use required
        ...
        public AlphaBetaNodeTEST parentNode;
        
        public AlphaBetaNodeTEST(char[][] masterBoard){
        ...
        public AlphaBetaNodeTEST(char[][] board, int score, int depth, boolean isMaxNode){
        ...
        public AlphaBetaNodeTEST( AlphaBetaNodeTEST parent, char[][] board, int score, int depth, boolean isMaxNode, int alpha, int beta){
        ...
        public char[][] getBestMove(){
            ...
            {
                for(BlackChecker O : blackCheckers){// cycle through the "level" --- ahhhhhhhhhhhhhhh this is MINMAX
                ...
                if(parentNode != null){
                    ...
                    System.out.println("AFTER completing one MIN NODE branch, the alpha is " + parentNode.parentNode.alpha + "parent beta is " + parentNode.parentNode.beta
        ...
        public void branch(char[][] board, int score){
           ...
           // System.out.println("its child is " +!isMaxNode);
            ...
            AlphaBetaNodeTEST T = new AlphaBetaNodeTEST(this, board, score, depthLevel +1, !isMaxNode, alpha, beta);
            T.getBestMove();
